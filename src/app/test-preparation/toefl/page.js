        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg md:text-xl mb-8">
              Comprehensive coaching to help you excel in your TOEFL iBT examination.
            </p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-gray-700 mb-4">
                Our TOEFL preparation course is designed to give you a comprehensive understanding of the test format and develop the skills needed to excel in all four sections: Reading, Listening, Speaking, and Writing.
              </p>
              <p className="text-gray-700">
                We focus on building your English proficiency while also teaching you the specific strategies needed for TOEFL success.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-700 mb-6">
                We're currently updating our TOEFL preparation course information. Please check back soon for detailed information about:
              </p>
              ...
              <p className="text-gray-700 mb-8">
                In the meantime, you can book a free consultation to discuss your TOEFL preparation needs with our expert trainers.
              </p>
