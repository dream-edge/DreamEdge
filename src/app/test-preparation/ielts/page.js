        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg md:text-xl mb-8">
              Expert coaching to help you achieve your target IELTS score for UK university admissions.
            </p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-gray-700 mb-4">
                Our IELTS preparation course is designed to give you a comprehensive understanding of the test format and develop the skills needed to excel in all four sections: Listening, Reading, Writing, and Speaking.
              </p>
              <p className="text-gray-700">
                Whether you&apos;re aiming for academic or general training modules, our experienced trainers will provide personalized guidance to help you achieve your target score.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-700 mb-6">
                We&apos;re currently updating our IELTS preparation course information. Please check back soon for detailed information about:
              </p>
              ...
              <p className="text-gray-700 mb-8">
                In the meantime, you can book a free consultation to discuss your IELTS preparation needs with our expert trainers.
              </p>
